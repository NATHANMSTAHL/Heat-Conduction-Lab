...
function [n_series, u_converge_1, u_converge_1000] = u_x_t (H, T0, k, rho, c_p)
...
[n_series_al_25, u_converge_1_al_25, u_converge_1000_al_25] = u_x_t (91.09, 17.04, 130, 2810, 960);



% Plot results
figure;
plot(n_series_al_25, u_converge_1_al_25, 'o-', 'LineWidth', 1.5);
hold on;
plot(n_series_al_25, u_converge_1000_al_25, 's-', 'LineWidth', 1.5);
